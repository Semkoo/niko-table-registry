...
Thanks for your interest in contributing to Shadcn Advanced React Table Registry. We're happy to have you here.
...
```bash
git clone git@github.com:Semkoo/shadcn-advance-react-table-registry.git
```
