...
// Sample data with enough wide columns to demonstrate horizontal scrolling + resize
const data: Order[] = [
  {
    id: "ORD-001",
    customer: "John Doe",
...
// Columns with explicit sizes so drag-resize is meaningful
...
export default function ColumnResizeTable() {
  return (
