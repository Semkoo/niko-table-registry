...
<CollapsiblePreview>
  <CodePreview demo="niko-table/advanced-state" />
</CollapsiblePreview>
...
5. **Install add-ons for this example** — This example uses pagination, search, view menu, sort menu, filter menu, column sort, and column-level faceted/slider/date filters. Run:
...
- Simple filtering is sufficient (use [Faceted Filter Table](/niko-table/faceted-filter-table))
- You prefer inline filters (use [Advanced Inline Filter Table](/niko-table/advanced-inline-table))
- You need URL state persistence (use [Advanced Nuqs Table](/niko-table/advanced-nuqs-table))

## Next Steps

- [Advanced Inline Filter Table](/niko-table/advanced-inline-table) - Build custom inline filter UIs
