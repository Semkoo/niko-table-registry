...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/core/data-table-context.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/hooks/use-debounce.ts`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/hooks/use-derived-column-title.ts`} external>Source Code ↗</DocsLink>
</div>
...
| ------------- | ------------------------ | ------------------------------- |
| `column`      | `DataTableColumn<TData>` | The table column.               |
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/hooks/use-generated-options.ts`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/hooks/use-keyboard-shortcut.ts`} external>Source Code ↗</DocsLink>
</div>
