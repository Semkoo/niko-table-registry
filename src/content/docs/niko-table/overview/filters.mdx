...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-search-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-pagination.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-filter-menu.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-faceted-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-slider-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
| Name            | Type                                             | Description                       |
| --------------- | ------------------------------------------------ | --------------------------------- |
| `column`        | `DataTableColumn<TData>`                         | Table column instance (required). |
| `title`         | `string`                                         | Filter title.                     |
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-date-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-sort-menu.tsx`} external>Source Code ↗</DocsLink>
</div>
...
Core view menu implementation for column visibility. For drag-to-reorder, use [`TableViewDndMenu`](#tableviewdndmenu) — it lives in a separate file so consumers who don't need DnD don't pay the `@dnd-kit/*` bundle cost.

<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-view-menu.tsx`} external>Source Code ↗</DocsLink>
</div>
...
Drag-to-reorder variant of `TableViewMenu`. Each row gets a `GripVertical` handle and the list becomes vertically sortable via `@dnd-kit`. The same `columnOrder` state the table consumes drives the menu's display order, so dropping a row updates both surfaces in lockstep. Combines cleanly with [`TableColumnDndProvider`](#tablecolumndndprovider) (header drag) — two reorder surfaces, one state.

<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-view-dnd-menu.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-inline-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-clear-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-export-button.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-range-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-title.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-actions.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-sort.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-hide.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-pin.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-faceted-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
| ----------- | -------------------------- | ------------------------------------ |
| `column`    | `DataTableColumn<TData>`   | Table column instance (required).    |
| `table`     | `DataTableInstance<TData>` | TanStack Table instance (Menu only). |
| `options`   | `Option[]`                 | Static options array.                |
| `multiple`  | `boolean`                  | Allow multiple selection.            |
| `className` | `string`                   | Additional CSS classes.              |
...
| Name        | Type                             | Default | Description                                |
| ----------- | -------------------------------- | ------- | ------------------------------------------ |
| `column`    | `DataTableColumn<TData, TValue>` | -       | TanStack Table column instance (required). |
| `className` | `string`                         | -       | Additional CSS classes.                    |
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-slider-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-date-filter.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-row-dnd.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-column-dnd.tsx`} external>Source Code ↗</DocsLink>
</div>
