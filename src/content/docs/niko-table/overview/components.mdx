...
| Name       | Type                             | Description                       |
| ---------- | -------------------------------- | --------------------------------- |
| `column`   | `DataTableColumn<TData, TValue>` | Table column instance (required). |
...
Grouping options to compose inside `DataTableColumnActions`. Renders **Group by** / **Stop grouping by**. Feature detection turns on `getGroupedRowModel` + expand/collapse. For nested data hierarchies, use a [Tree Table](/examples/tree-table/) (`getSubRows`) instead — don’t combine the two.

| Name            | Type      | Default | Description                                       |
| --------------- | --------- | ------- | ------------------------------------------------- |
| `withSeparator` | `boolean` | `true`  | Whether to render a separator before the options. |

##### DataTableColumnGroupMenu

Standalone grouping menu for column header. Renders as a clickable button.
...
| Name        | Type                     | Description                                     |
| ----------- | ------------------------ | ----------------------------------------------- |
| `column`    | `DataTableColumn<TData>` | Optional override (auto-detected from context). |
| `options`   | `Option[]`               | Static options array.                           |
| `multiple`  | `boolean`                | Allow multiple selection.                       |
| `className` | `string`                 | Additional CSS classes.                         |
...
| Name        | Type                  | Default | Description                             |
| ----------- | --------------------- | ------- | --------------------------------------- |
| `row`       | `DataTableRow<TData>` | -       | TanStack Table row instance (required). |
...
| Name        | Type                             | Default | Description                                |
| ----------- | -------------------------------- | ------- | ------------------------------------------ |
| `header`    | `DataTableHeader<TData, TValue>` | -       | TanStack Table header instance (required). |
...
| Name        | Type                           | Default | Description                              |
| ----------- | ------------------------------ | ------- | ---------------------------------------- |
| `cell`      | `DataTableCell<TData, TValue>` | -       | TanStack Table cell instance (required). |
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/components/data-table-column-group.tsx`} external>Source Code ↗</DocsLink>
</div>

Renders **Group by** / **Stop grouping by** menu items. Honors `column.getCanGroup()`. Wraps `TableColumnGroup` from `filters/`. See [Grouping Table](/examples/grouping-table/). Not the same as a [Tree Table](/examples/tree-table/) (`getSubRows`) — use one or the other per table.
