...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/components/data-table-view-dnd-menu.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
  ...
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/filters/table-view-dnd-menu.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Filter Implementation ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/components/data-table-row-dnd.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/components/data-table-column-dnd.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
