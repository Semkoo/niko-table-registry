...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/lib/create-scroll-handler.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/lib/row-click.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
