...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/core/data-table-dnd-structure.tsx`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/core/data-table-virtualized-dnd-structure.tsx`} external>Source Code ↗</DocsLink>
</div>
