...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/config/data-table.ts`} external>Source Code ↗</DocsLink>
</div>
...
<div className="not-content mb-4 flex items-center gap-2">
  <DocsLink href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/config/feature-detection.ts`} external>Source Code ↗</DocsLink>
</div>
