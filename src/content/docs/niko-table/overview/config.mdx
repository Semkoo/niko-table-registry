...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/config/data-table.ts`}
      target="_blank"
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-table/config/feature-detection.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
- `DataTableColumnTitle` - `{ enableSorting: true }`
