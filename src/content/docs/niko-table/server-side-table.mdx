...
description: Server-side pagination, sorting, and filtering with TanStack Query for efficient data fetching and caching.
---
...
<CliCommandCode action="install" command="@tanstack/react-table @tanstack/react-query" />

**Note:** [TanStack Query](https://tanstack.com/query/latest) provides powerful asynchronous state management, server-state utilities, and data fetching capabilities. It handles caching, background updates, and stale data out of the box with zero-configuration.
...
5. **Install add-ons for this example** — This example uses sort menu, filter menu, pagination, search, view menu, column sort, and column-level faceted/slider/date filters. Run:

<CliCommandCode action="run" command={'shadcn@latest add "https://niko-table.com/r/data-table-pagination.json" "https://niko-table.com/r/data-table-search-filter.json" "https://niko-table.com/r/data-table-view-menu.json" "https://niko-table.com/r/data-table-sort-menu.json" "https://niko-table.com/r/data-table-filter-menu.json" "https://niko-table.com/r/data-table-column-sort.json" "https://niko-table.com/r/data-table-column-faceted-filter.json" "https://niko-table.com/r/data-table-column-slider-filter.json" "https://niko-table.com/r/data-table-column-date-filter.json"'} />
...
```tsx showLineNumbers title="server-side-state.tsx"
...
This example uses React `useState` for state management. State does NOT persist across page refreshes. If you need URL state persistence, see the [Server-Side Nuqs Table](/niko-table/server-side-nuqs-table) example.
...
- You need URL state persistence - use [Server-Side Nuqs Table](/niko-table/server-side-nuqs-table)
- You need bookmarkable/shareable table views - use [Server-Side Nuqs Table](/niko-table/server-side-nuqs-table)
...
- [Advanced Table](/niko-table/advanced-table) - Learn about advanced filtering
- [Server-Side Nuqs Table](/niko-table/server-side-nuqs-table) - Add URL state persistence
