...
<CliCommandCode action="install" command="@tanstack/react-table nuqs" />
...
5. **Install add-ons for this example** — This example uses the same add-ons as Advanced Table (sort menu, filter menu, pagination, search, view menu, column sort, column faceted/slider/date filters). Run:
