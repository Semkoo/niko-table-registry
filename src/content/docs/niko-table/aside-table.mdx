...
<CollapsiblePreview>
  <CodePreview demo="niko-table/aside-state" />
</CollapsiblePreview>
...
<CliCommandCode action="run" command="shadcn@latest add table input button dropdown-menu scroll-area" />
...
5. **Install add-ons for this example** — This example uses aside, pagination, search, view menu, and column sort. Run:

<CliCommandCode action="run" command={'shadcn@latest add "https://niko-table.com/r/data-table-aside.json" "https://niko-table.com/r/data-table-pagination.json" "https://niko-table.com/r/data-table-search-filter.json" "https://niko-table.com/r/data-table-view-menu.json" "https://niko-table.com/r/data-table-column-sort.json"'} />
...
- You don't need additional panels (use [Basic Table](/niko-table/basic-table))
- You prefer inline expansion (use [Row Expansion Table](/niko-table/row-expansion-table))

## Next Steps

- [Row Expansion Table](/niko-table/row-expansion-table) - Expand rows inline
- [Advanced Table](/niko-table/advanced-table) - Combine all features
