...
<CliCommandCode action="run" command="shadcn@latest add table input button dropdown-menu card separator" />
...
5. **Install add-ons for this example** — This example uses pagination, search, view menu, and column sort. Run:

<CliCommandCode action="run" command={'shadcn@latest add "https://niko-table.com/r/data-table-pagination.json" "https://niko-table.com/r/data-table-search-filter.json" "https://niko-table.com/r/data-table-view-menu.json" "https://niko-table.com/r/data-table-column-sort.json"'} />
