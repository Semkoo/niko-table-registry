...
<CodePreview demo="niko-tables/virtualization-table" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/virtualization-table-state" />
</CollapsiblePreview>
...
- You have < 1000 rows (use [Basic Table](/niko-tables/basic-table))
...
- [Basic Table](/niko-tables/basic-table) - For smaller datasets
