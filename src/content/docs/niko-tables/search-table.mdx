...
<CodePreview demo="niko-tables/search" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/search-state" />
</CollapsiblePreview>
...
- You need column-specific filters (use [Advanced Table](/niko-tables/advanced-table))
- Dataset is > 1000 rows (implement server-side filtering)
- Search is not the primary use case (use [Basic Table](/niko-tables/basic-table))

## Next Steps

- [Advanced Table](/niko-tables/advanced-table) - Add advanced filtering and sorting menus
