...
<CodePreview demo="niko-tables/simple" />
...
- You have more than 50 rows (use [Basic Table](/niko-tables/basic-table) with pagination)
- Users need to search or filter data (use [Search Table](/niko-tables/search-table))
- Users need to sort columns (use [Basic Table](/niko-tables/basic-table))

## Next Steps

Once you're comfortable with the Simple Table, try adding more features:

- [Basic Table](/niko-tables/basic-table) - Add pagination and sorting
- [Search Table](/niko-tables/search-table) - Add search functionality
