...
<CodePreview demo="niko-tables/aside" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/aside-state" />
</CollapsiblePreview>
...
- You don't need additional panels (use [Basic Table](/niko-tables/basic-table))
- You prefer inline expansion (use [Row Expansion Table](/niko-tables/row-expansion-table))

## Next Steps

- [Row Expansion Table](/niko-tables/row-expansion-table) - Expand rows inline
- [Advanced Table](/niko-tables/advanced-table) - Combine all features
