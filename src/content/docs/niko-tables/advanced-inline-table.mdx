...
<CodePreview demo="niko-tables/advanced-inline" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/advanced-inline-state" />
</CollapsiblePreview>
...
- You need complex rule-based filtering (use [Advanced Filter Table](/niko-tables/advanced-table))
- You want filter menus (use [Advanced Filter Table](/niko-tables/advanced-table))
- You need URL state persistence (use [Advanced Nuqs Table](/niko-tables/advanced-nuqs-table))

## Next Steps

- [Advanced Filter Table](/niko-tables/advanced-table) - Add rule-based filter menus
