...
<CodePreview demo="niko-tables/advanced" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/advanced-state" />
</CollapsiblePreview>
...
- Simple filtering is sufficient (use [Faceted Filter Table](/niko-tables/faceted-filter-table))
- You prefer inline filters (use [Advanced Inline Filter Table](/niko-tables/advanced-inline-table))
- You need URL state persistence (use [Advanced Nuqs Table](/niko-tables/advanced-nuqs-table))

## Next Steps

- [Advanced Inline Filter Table](/niko-tables/advanced-inline-table) - Build custom inline filter UIs
- [Advanced Nuqs Table](/niko-tables/advanced-nuqs-table) - Add URL state persistence
