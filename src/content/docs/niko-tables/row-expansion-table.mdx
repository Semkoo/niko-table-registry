...
<CodePreview demo="niko-tables/row-expansion" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/row-expansion-state" />
</CollapsiblePreview>
...
- You need to show details for all rows (use [Aside Table](/niko-tables/aside-table))
- Expanded content is very large (use [Aside Table](/niko-tables/aside-table))
- You don't need additional details (use [Basic Table](/niko-tables/basic-table))

## Next Steps

- [Aside Table](/niko-tables/aside-table) - Show details in sidebars
- [Tree Table](/niko-tables/tree-table) - Hierarchical data with expansion
