...
<CodePreview demo="niko-tables/basic" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/basic-state" />
</CollapsiblePreview>
...
- Dataset is < 50 rows (use [Simple Table](/niko-tables/simple-table))
- Users need to search (use [Search Table](/niko-tables/search-table))
- You need advanced filters (use [Advanced Table](/niko-tables/advanced-table))

## Next Steps

- [Search Table](/niko-tables/search-table) - Add global search
- [Advanced Table](/niko-tables/advanced-table) - Add advanced filtering
