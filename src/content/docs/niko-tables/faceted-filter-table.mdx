...
<CodePreview demo="niko-tables/faceted" />

<CollapsiblePreview>
  <CodePreview demo="niko-tables/faceted-state" />
</CollapsiblePreview>
...
- You need complex rule-based filtering (use [Advanced Table](/niko-tables/advanced-table))
- You prefer dropdown filters (use [Advanced Table](/niko-tables/advanced-table))
- You only need search (use [Search Table](/niko-tables/search-table))

## Next Steps

- [Advanced Table](/niko-tables/advanced-table) - Add advanced filtering menus
