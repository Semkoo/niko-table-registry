...
<CodePreview demo="niko-tables/advanced-nuqs-state" />
...
- URL state is not needed (use [Advanced Filter Table](/niko-tables/advanced-table))
- You prefer simpler state management
- You don't need shareable/bookmarkable views

## Next Steps

- [Advanced Filter Table](/niko-tables/advanced-table) - Rule-based filtering without URL state
- [Advanced Inline Filter Table](/niko-tables/advanced-inline-table) - Custom inline filter UIs
