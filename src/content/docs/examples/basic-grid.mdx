---
title: Basic Grid
description: Minimal editable Data Grid — text cells, virtualization, undo/redo.
---
...
<Aside type="tip">
  Mount only what you need. Clipboard / fill / move are children of `<DataGrid>`; see [All Features Grid](/examples/all-features-grid/).
</Aside>

## Next

- [All Features Grid](/examples/all-features-grid/) — clipboard, fill, filters, dynamic columns
