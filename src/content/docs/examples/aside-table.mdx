...
<CliCommandCode action="run" command="shadcn@latest add @niko-table/data-table @niko-table/data-table-aside @niko-table/data-table-pagination @niko-table/data-table-search-filter @niko-table/data-table-view-menu @niko-table/data-table-column-sort" />

This example also uses `scroll-area` from Shadcn UI:

<CliCommandCode action="run" command="shadcn@latest add scroll-area" />
...
- You don't need additional panels (use [Basic Table](/examples/basic-table/))
- You prefer inline expansion (use [Row Expansion Table](/examples/row-expansion-table/))

## Next Steps

- [Row Expansion Table](/examples/row-expansion-table/) - Expand rows inline
- [Advanced Table](/examples/advanced-table/) - Combine all features
