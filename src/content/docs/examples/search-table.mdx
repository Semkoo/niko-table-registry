...
<CliCommandCode action="run" command="shadcn@latest add @niko-table/data-table @niko-table/data-table-search-filter @niko-table/data-table-pagination @niko-table/data-table-view-menu @niko-table/data-table-column-sort" />
...
- You need column-specific filters (use [Advanced Table](/examples/advanced-table/))
- Dataset is > 1000 rows (implement server-side filtering)
- Search is not the primary use case (use [Basic Table](/examples/basic-table/))

## Next Steps

- [Advanced Table](/examples/advanced-table/) - Add advanced filtering and sorting menus
