...
- URL state is not needed (use [Advanced Filter Table](/examples/advanced-table/))
- You prefer simpler state management
- You don't need shareable/bookmarkable views

## Next Steps

- [Advanced Filter Table](/examples/advanced-table/) - Rule-based filtering without URL state
- [Advanced Inline Filter Table](/examples/advanced-inline-table/) - Custom inline filter UIs
