...
- Simple filtering is sufficient (use [Faceted Filter Table](/examples/faceted-filter-table/))
- You prefer inline filters (use [Advanced Inline Filter Table](/examples/advanced-inline-table/))
- You need URL state persistence (use [Advanced Nuqs Table](/examples/advanced-nuqs-table/))

## Next Steps

- [Advanced Inline Filter Table](/examples/advanced-inline-table/) - Build custom inline filter UIs
