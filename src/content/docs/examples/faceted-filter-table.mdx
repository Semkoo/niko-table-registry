...
- You need complex rule-based filtering (use [Advanced Table](/examples/advanced-table/))
- You prefer dropdown filters (use [Advanced Table](/examples/advanced-table/))
- You only need search (use [Search Table](/examples/search-table/))

## Next Steps

- [Advanced Table](/examples/advanced-table/) - Add advanced filtering menus
