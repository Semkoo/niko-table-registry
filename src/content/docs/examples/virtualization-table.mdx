...
<CliCommandCode action="run" command="shadcn@latest add @niko-table/data-table @niko-table/data-table-virtualized @niko-table/data-table-pagination @niko-table/data-table-search-filter @niko-table/data-table-view-menu @niko-table/data-table-column-sort" />
...
- You have < 1000 rows (use [Basic Table](/examples/basic-table/))
...
- [Basic Table](/examples/basic-table/) - For smaller datasets
