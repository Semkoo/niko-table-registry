...
Not a [Tree Table](/examples/tree-table/) (nested `getSubRows`) and not [Grouping](/examples/grouping-table/) (column buckets) — expansion here reveals an **inline detail panel** for one flat row.
...
<CliCommandCode action="run" command="shadcn@latest add card separator" />
...
- Data is hierarchical parent/child rows — use [Tree Table](/examples/tree-table/)
- You want to bucket flat rows by column values — use [Grouping Table](/examples/grouping-table/)
- Expanded content is very large or always visible — use [Aside Table](/examples/aside-table/)

## Next Steps

- [Aside Table](/examples/aside-table/) — show details in sidebars
