...
- You need to show details for all rows (use [Aside Table](/examples/aside-table))
- Expanded content is very large (use [Aside Table](/examples/aside-table))
- You don't need additional details (use [Basic Table](/examples/basic-table))

## Next Steps

- [Aside Table](/examples/aside-table) - Show details in sidebars
- [Tree Table](/examples/tree-table) - Hierarchical data with expansion
