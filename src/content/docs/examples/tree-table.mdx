...
<CollapsiblePreview>
  <CodePreview demo="niko-table/tree-table-state" />
</CollapsiblePreview>
...
|                       | Tree                         | [Grouping Table](/examples/grouping-table/)   |
| --------------------- | ---------------------------- | --------------------------------------------- |
...
<CliCommandCode action="run" command="shadcn@latest add @niko-table/data-table @niko-table/data-table-selection-bar @niko-table/data-table-pagination @niko-table/data-table-search-filter @niko-table/data-table-view-menu @niko-table/data-table-column-sort" />
...
- Data is flat and you want to bucket by column values — use [Grouping Table](/examples/grouping-table/)
- You need per-row detail panels — use [Row Expansion](/examples/row-expansion-table/)
- You prefer sidebars for details — use [Aside Table](/examples/aside-table/)
...
- [Advanced Table](/examples/advanced-table/) — combine with other features
