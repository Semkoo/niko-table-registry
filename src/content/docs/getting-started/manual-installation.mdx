...
2. **Install the required Shadcn UI components**
   ...
   <CliCommandCode
     action="run"
     command="npx shadcn@latest add table button input dropdown-menu"
   />
...
5. **Update import paths**
   ...
   - `@/components/data-table/` for DataTable components
...
- [Simple Table](/data-table/simple-table) - Basic table with no pagination
...
- [Faceted Filter Table](/data-table/faceted-filter-table) - Add advanced filtering
