...
| `data-table-column-resize`         | Column resize handle + double-click to auto-fit. |
...
<CliCommandCode action="run" command="shadcn@latest add @niko-table/data-table-column-sort @niko-table/data-table-column-hide @niko-table/data-table-column-pin @niko-table/data-table-column-resize" />
