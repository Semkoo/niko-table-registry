...
Just like Shadcn, Niko Tables is **not a component library**. Instead, it's a comprehensive **DataTable component** that you copy into your project and customize to your needs. It's built with TanStack Table and Shadcn UI, providing enterprise-grade features while remaining fully under your control.
...
- All DataTable component files from `/components/niko-tables/`
...
2. **[Simple Table](/niko-tables/simple-table)** - Your first table
3. **[Basic Table](/niko-tables/basic-table)** - Add common features
4. **[Search Table](/niko-tables/search-table)** - Add search
5. **[Faceted Filter Table](/niko-tables/faceted-filter-table)** - Advanced filtering
6. **[Advanced Table](/niko-tables/advanced-table)** - Master level
