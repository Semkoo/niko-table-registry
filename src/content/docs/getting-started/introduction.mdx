...
2. **[Simple Table](/niko-table/simple-table)** - Your first table
3. **[Basic Table](/niko-table/basic-table)** - Add common features
4. **[Search Table](/niko-table/search-table)** - Add search
5. **[Faceted Filter Table](/niko-table/faceted-filter-table)** - Advanced filtering
6. **[Advanced Table](/niko-table/advanced-table)** - Master level
