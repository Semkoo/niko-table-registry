...
## What is NikoDataTable?

**Nobody's table, everyone's solution.**

Just like Shadcn, NikoDataTable is **not a component library**. Instead, it's a comprehensive **DataTable component** that you copy into your project and customize to your needs. It's built with TanStack Table and Shadcn UI, providing enterprise-grade features while remaining fully under your control.
...
- All DataTable component files from `/components/niko-data-table/`
...
2. **[Simple Table](/niko-data-table/simple-table)** - Your first table
3. **[Basic Table](/niko-data-table/basic-table)** - Add common features
4. **[Search Table](/niko-data-table/search-table)** - Add search
5. **[Filter Table](/niko-data-table/filter-table)** - Advanced filtering
6. **[Advanced Table](/niko-data-table/advanced-table)** - Master level
