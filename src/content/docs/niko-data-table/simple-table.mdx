...
<CodePreview demo="niko-data-table/simple" />
...
- You have more than 50 rows (use [Basic Table](/niko-data-table/basic-table) with pagination)
- Users need to search or filter data (use [Search Table](/niko-data-table/search-table))
- Users need to sort columns (use [Basic Table](/niko-data-table/basic-table))
