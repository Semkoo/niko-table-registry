...
<CodePreview demo="niko-data-table/virtualization-table" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/virtualization-table-state" />
</CollapsiblePreview>
...
- You have < 1000 rows (use [Basic Table](/niko-data-table/basic-table))
...
- [Basic Table](/niko-data-table/basic-table) - For smaller datasets
