...
<CodePreview demo="niko-data-table/column-pinning" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/column-pinning-state" />
</CollapsiblePreview>
...
- [Virtualization Table](/niko-data-table/virtualization-table) - Combine pinning with virtual scrolling
- [Advanced Table](/niko-data-table/advanced-table) - Persistent pinning state
