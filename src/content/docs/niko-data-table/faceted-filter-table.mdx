...
<CodePreview demo="niko-data-table/faceted" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/faceted-state" />
</CollapsiblePreview>
...
- You need complex rule-based filtering (use [Advanced Table](/niko-data-table/advanced-table))
- You prefer dropdown filters (use [Advanced Table](/niko-data-table/advanced-table))
- You only need search (use [Search Table](/niko-data-table/search-table))

## Next Steps

- [Advanced Table](/niko-data-table/advanced-table) - Add advanced filtering menus
