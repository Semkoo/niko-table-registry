...
<figure className="flex flex-col gap-4">
  <CodePreview
    demo="niko-data-table/all-features-table"
    title="DataTable"
    type="block"
...
[Browse the Examples](/niko-data-table/simple-table).
...
5. **You've created your first table!**
   ...
   Your table now has search functionality and pagination. See the [Examples](/niko-data-table/simple-table) for more advanced configurations.
...
See the [Components](/niko-data-table/components) page for detailed documentation on each component.
...
- [Components](/niko-data-table/components) - Detailed component documentation
- [Simple Table](/niko-data-table/simple-table) - Basic table example
- [Basic Table](/niko-data-table/basic-table) - Table with pagination and sorting
- [Advanced Table](/niko-data-table/advanced-table) - Complex filtering and sorting
- [Server-Side Table](/niko-data-table/server-side-table) - Server-side data handling
...
- `TableColumnHeader` - Sortable column header
