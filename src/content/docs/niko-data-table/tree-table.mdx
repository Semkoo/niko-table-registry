...
<CodePreview demo="niko-data-table/tree-table" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/tree-table-state" />
</CollapsiblePreview>
...
- Data is flat (use [Basic Table](/niko-data-table/basic-table))
- You don't need hierarchical structure
- You prefer sidebars for details (use [Aside Table](/niko-data-table/aside-table))

## Next Steps

- [Row Expansion Table](/niko-data-table/row-expansion-table) - Simple row expansion
- [Advanced Table](/niko-data-table/advanced-table) - Combine with other features
