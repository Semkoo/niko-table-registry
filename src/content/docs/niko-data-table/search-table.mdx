...
<CodePreview demo="niko-data-table/search" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/search-state" />
</CollapsiblePreview>
...
- You need column-specific filters (use [Advanced Table](/niko-data-table/advanced-table))
- Dataset is > 1000 rows (implement server-side filtering)
- Search is not the primary use case (use [Basic Table](/niko-data-table/basic-table))

## Next Steps

- [Advanced Table](/niko-data-table/advanced-table) - Add advanced filtering and sorting menus
