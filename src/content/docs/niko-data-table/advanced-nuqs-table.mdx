...
<CodePreview demo="niko-data-table/advanced-nuqs-state" />
...
- URL state is not needed (use [Advanced Filter Table](/niko-data-table/advanced-table))
- You prefer simpler state management
- You don't need shareable/bookmarkable views

## Next Steps

- [Advanced Filter Table](/niko-data-table/advanced-table) - Rule-based filtering without URL state
- [Advanced Inline Filter Table](/niko-data-table/advanced-inline-table) - Custom inline filter UIs
