...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table-context.tsx`}
      target="_blank"
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/hooks/use-debounce.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
```tsx showLineNumbers
import { useDebounce } from "@/components/niko-data-table/hooks"
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/hooks/use-derived-column-title.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/hooks/use-generated-options.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/hooks/use-keyboard-shortcut.ts`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
```tsx showLineNumbers
import { useKeyboardShortcut } from "@/components/niko-data-table/hooks"
