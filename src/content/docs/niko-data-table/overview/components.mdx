...
import {
  ...
  DataDataTableColumnFilterTrigger,
        ...
        <DataTableColumnActions>
          <DataTableColumnFilter>
            <DataTableFacetedFilter
              ...
              trigger={<DataDataTableColumnFilterTrigger />}
            />
          </DataTableColumnFilter>
          <DataTableColumnSortOptions />
        </DataTableColumnActions>
...
- **`DataTableColumnTitle`**: Renders the column title (clickable to toggle sort).
- **`DataTableColumnActions`**: Container for action icons and dropdown menu for column options.
- **`DataTableColumnFilter`**: Wrapper for filter components.
- **`DataDataTableColumnFilterTrigger`**: Dedicated filter icon button.
- **`DataTableColumnSortOptions`**: Sorting options to compose inside DataTableColumnActions.
- **`DataTableColumnPinOptions`**: Pinning options to compose inside DataTableColumnActions.
- **`DataTableColumnHideOptions`**: Hide column option to compose inside DataTableColumnActions.
