...
| Name                 | Type                                                              | Description                                              |
| -------------------- | ----------------------------------------------------------------- | -------------------------------------------------------- |
| `column`             | `Column<TData>`                                                   | The column instance from TanStack Table (required).      |
| `title`              | `string`                                                          | Custom title (uses `column.meta.label` if not provided). |
| `variant`            | `"text" \| "number" \| "date" \| "boolean"`                       | Sort icon variant based on data type.                    |
| `className`          | `string`                                                          | Additional CSS classes.                                  |
| `onSort`             | `(columnId: string, direction: "asc" \| "desc" \| false) => void` | Callback when sort changes.                              |
| `onVisibilityChange` | `(columnId: string, isVisible: boolean) => void`                  | Callback when visibility changes.                        |
