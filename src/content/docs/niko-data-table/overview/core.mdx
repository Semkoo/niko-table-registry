...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table-root.tsx`}
      target="_blank"
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table-structure.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table-error-boundary.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
...
```tsx showLineNumbers
import { DataTableErrorBoundary } from "@/components/niko-table"
;<DataTableErrorBoundary
...
<div className="mb-4 flex gap-2">
  <Button variant="outline" size="sm" asChild>
    <a
      href={`${GITHUB_REPO_URL}/blob/main/src/components/niko-data-table/core/data-table-virtualized-structure.tsx`}
      target="_blank"
      rel="noopener noreferrer"
    >
      Source Code ↗
