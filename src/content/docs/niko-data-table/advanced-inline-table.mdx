...
<CodePreview demo="niko-data-table/advanced-inline" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/advanced-inline-state" />
</CollapsiblePreview>
...
- You need complex rule-based filtering (use [Advanced Filter Table](/niko-data-table/advanced-table))
- You want filter menus (use [Advanced Filter Table](/niko-data-table/advanced-table))
- You need URL state persistence (use [Advanced Nuqs Table](/niko-data-table/advanced-nuqs-table))

## Next Steps

- [Advanced Filter Table](/niko-data-table/advanced-table) - Add rule-based filter menus
