...
<CodePreview demo="niko-data-table/row-expansion" />

<CollapsiblePreview>
  <CodePreview demo="niko-data-table/row-expansion-state" />
</CollapsiblePreview>
...
- You need to show details for all rows (use [Aside Table](/niko-data-table/aside-table))
- Expanded content is very large (use [Aside Table](/niko-data-table/aside-table))
- You don't need additional details (use [Basic Table](/niko-data-table/basic-table))

## Next Steps

- [Aside Table](/niko-data-table/aside-table) - Show details in sidebars
- [Tree Table](/niko-data-table/tree-table) - Hierarchical data with expansion
