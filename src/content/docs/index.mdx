...
Just like Shadcn, Niko Tables is **not a component library**. Instead, it's a comprehensive **DataTable component** that you copy into your project and customize to your needs. Built with **TanStack Table** and **Shadcn UI**, it provides enterprise-grade features while remaining fully under your control.

## Live Demo

See ALL features in action with this comprehensive example:

<CodePreview demo="niko-tables/all-features-table" />
...
- **[Simple Table](/niko-tables/simple-table)** - Basic rendering
- **[Basic Table](/niko-tables/basic-table)** - Pagination and sorting
- **[Search Table](/niko-tables/search-table)** - Add global search
- **[Faceted Filter Table](/niko-tables/faceted-filter-table)** - Column-specific filters
- **[Advanced Table](/niko-tables/advanced-table)** - All features combined
- **[Advanced Nuqs Table](/niko-tables/advanced-nuqs-table)** - URL state persistence
