...
- **Composable** - Mix and match components (install only the registry pieces you need). TanStack Table v9 mirrors that at the engine: register only the features you use in `lib/data-table-features.ts`
