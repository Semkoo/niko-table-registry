...
Just like Shadcn, NikoDataTable is **not a component library**. Instead, it's a comprehensive **DataTable component** that you copy into your project and customize to your needs. Built with **TanStack Table** and **Shadcn UI**, it provides enterprise-grade features while remaining fully under your control.

## Live Demo

See ALL features in action with this comprehensive example:

<CodePreview demo="niko-data-table/all-features-table" />
...
- **[Simple Table](/niko-data-table/simple-table)** - Basic rendering
- **[Basic Table](/niko-data-table/basic-table)** - Pagination and sorting
- **[Search Table](/niko-data-table/search-table)** - Add global search
- **[Faceted Filter Table](/niko-data-table/faceted-filter-table)** - Column-specific filters
- **[Advanced Table](/niko-data-table/advanced-table)** - All features combined
- **[Advanced Nuqs Table](/niko-data-table/advanced-nuqs-table)** - URL state persistence
