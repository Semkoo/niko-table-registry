...
- **[Simple Table](/niko-table/simple-table)** - Basic rendering
- **[Basic Table](/niko-table/basic-table)** - Pagination and sorting
- **[Search Table](/niko-table/search-table)** - Add global search
- **[Faceted Filter Table](/niko-table/faceted-filter-table)** - Column-specific filters
- **[Advanced Table](/niko-table/advanced-table)** - All features combined
- **[Advanced Nuqs Table](/niko-table/advanced-nuqs-table)** - URL state persistence
