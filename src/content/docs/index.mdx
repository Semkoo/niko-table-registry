...
Just like Shadcn, NikoTable is **not a component library**. Instead, it's a comprehensive **DataTable component** that you copy into your project and customize to your needs. Built with **TanStack Table** and **Shadcn UI**, it provides enterprise-grade features while remaining fully under your control.
