...
- **[Cell Types](/data-grid/cell-types/)** - Text, number, currency, checkbox, date, and select editors
- **[Validation](/data-grid/validation/)** - Inline per-cell errors with Zod (or any `resolve`)
- **[Dynamic Columns](/data-grid/dynamic-columns/)** - Add, rename, move, delete, and retype at runtime
- **[Persistence](/data-grid/persistence/)** - Create / update / delete change-sets with `useGridChanges`
