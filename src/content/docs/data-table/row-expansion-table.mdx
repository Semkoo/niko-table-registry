...
<CodePreview demo="data-table/row-expansion" />

<CollapsiblePreview>
  <CodePreview demo="data-table/row-expansion-state" />
</CollapsiblePreview>
...
- You need to show details for all rows (use [Aside Table](/data-table/aside-table))
- Expanded content is very large (use [Aside Table](/data-table/aside-table))
- You don't need additional details (use [Basic Table](/data-table/basic-table))

## Next Steps

- [Aside Table](/data-table/aside-table) - Show details in sidebars
- [Tree Table](/data-table/tree-table) - Hierarchical data with expansion
