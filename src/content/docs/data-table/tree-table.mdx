...
<CodePreview demo="data-table/tree-table" />

<CollapsiblePreview>
  <CodePreview demo="data-table/tree-table-state" />
</CollapsiblePreview>
...
- Data is flat (use [Basic Table](/data-table/basic-table))
- You don't need hierarchical structure
- You prefer sidebars for details (use [Aside Table](/data-table/aside-table))

## Next Steps

- [Row Expansion Table](/data-table/row-expansion-table) - Simple row expansion
