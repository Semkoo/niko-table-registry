...
<div className="mb-6 flex gap-2">
  <a
    ...
    className="inline-flex items-center gap-1 rounded-md bg-zinc-800 px-3 py-1.5 text-sm font-medium text-zinc-100 no-underline transition-colors hover:bg-zinc-700"
  >
    Docs ↗
  </a>
  <a
...
```tsx showLineNumbers
import { DataTableRoot } from "@/components/data-table"
...
```tsx showLineNumbers
import { DataTableSearchFilter } from "@/components/data-table"
...
```tsx showLineNumbers
import { DataTableFilterMenu } from "@/components/data-table"
;<DataTableFilterMenu
  autoOptions
  dynamicCounts
  showCounts
...
```tsx showLineNumbers
import { DataTableSortMenu } from "@/components/data-table"
...
```tsx showLineNumbers
import { DataTableViewMenu } from "@/components/data-table"
;<DataTableViewMenu />
```
...
```tsx showLineNumbers
import { DataTableInlineFilter } from "@/components/data-table"
...
```tsx showLineNumbers
import { DataTableSliderFilter } from "@/components/data-table"
...
```tsx showLineNumbers
import { DataTableClearFilter } from "@/components/data-table"
;<DataTableClearFilter />
```
...
```tsx showLineNumbers
import { DataTableExportButton } from "@/components/data-table"
;<DataTableExportButton />
```
...
```tsx showLineNumbers
import { DataTableSelectionBar } from "@/components/data-table"
