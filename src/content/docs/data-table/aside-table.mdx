...
<CodePreview demo="data-table/aside" />

<CollapsiblePreview>
  <CodePreview demo="data-table/aside-state" />
</CollapsiblePreview>
...
- You don't need additional panels (use [Basic Table](/data-table/basic-table))
- You prefer inline expansion (use [Row Expansion Table](/data-table/row-expansion-table))

## Next Steps

- [Row Expansion Table](/data-table/row-expansion-table) - Expand rows inline
- [Advanced Table](/data-table/advanced-table) - Combine all features
