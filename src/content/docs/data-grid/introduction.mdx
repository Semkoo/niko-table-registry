...
Turn a Niko Table into an editable spreadsheet. You get virtualization, sort,
filter, pin, and resize from the table, plus a headless edit engine: focus,
selection, undo/redo, and clipboard.
...
- [Basic Grid](/examples/basic-grid/) · [Composed Grid](/examples/composed-grid/): examples
